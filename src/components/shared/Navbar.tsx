...
//           <Link
//             href="/register"
//             className="px-5 py-2 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white font-semibold shadow-lg hover:scale-105 transition duration-300"
//           >
//             Get Started
//           </Link>
...
//       {/* Mobile Menu */}
//       {isOpen && (
//         <div className="md:hidden bg-white/80 dark:bg-black/80 backdrop-blur-lg 
//           border-t border-gray-200 dark:border-white/20 
//           px-6 py-4 space-y-4">

//           <Link href="/features" className="block text-gray-800 dark:text-gray-200 hover:text-blue-500">
//             Features
//           </Link>
//           <Link href="/pricing" className="block text-gray-800 dark:text-gray-200 hover:text-blue-500">
//             Pricing
//           </Link>
//           <Link href="/login" className="block text-gray-800 dark:text-gray-200 hover:text-blue-500">
//             Login
//           </Link>
//           <Link
//             href="/register"
    ...
    <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-lg bg-white/70 dark:bg-black/40 border-b border-gray-200 dark:border-white/20 shadow-lg">
      <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          {!user ? (
            <>
              <Link href="/login" className="text-gray-800 dark:text-gray-200 hover:text-blue-500 transition">Login</Link>
              <Link
                href="/register"
